Ember.Charts.HorizontalBarEpiComponent = Ember.Charts.ChartComponent.extend(
  Ember.Charts.FloatingTooltipMixin,
  classNames: ['chart-horizontal-bar-epi']
...
Ember.Handlebars.helper('horizontal-bar-epi-chart', Ember.Charts.HorizontalBarEpiComponent)
